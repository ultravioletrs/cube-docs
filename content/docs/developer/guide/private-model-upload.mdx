...
title: Uploading Private Models to Cube AI
sidebar_position: 3
---
...
_Cube AI Services menu in Buildroot menuconfig showing the Ollama section and available configuration options_
...
_Entering model tags in the Custom models to install input dialog_
...
_LLM Backend selection dialog — choose between Ollama, vLLM, or a Custom URL endpoint_

![Custom Target URL entry](/img/buildroot-llm-custom-url.png)
_Custom Target URL dialog for pointing the Cube Agent at an external LLM backend_
