...
Attestation evidence and aTLS verification can be inspected through audit logs or retrieved via the proxy without requiring any client-side deployment or manual verification steps.
